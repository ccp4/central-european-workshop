...
const day1: Day = {
  ...
  sessions: [
    {
      title: "Welcome – Organisation announcements, acknowledgement of sponsors and co-organisers",
      type: "Other",
      time: "17:00",
...
const day2: Day = {
  ...
  sessions: [
    ...
    {
      title: "Diffraction data processing",
      type: "Lecture",
      time: "11:00",
    },
    {
      title: "Diffraction data processing I",
      type: "Tutorial",
      time: "11:30",
    ...
    {
      title: "Diffraction data processing II",
      type: "Tutorial",
      time: "14:00",
      speakers: [david_waterman],
    },
    { title: "Break", time: "14:45", type: "Break" },
    {
      title: "Indicators of diffraction data quality",
      type: "Lecture",
      time: "15:00",
      speakers: [kay_diederichs],
    },
    { title: "Break", time: "15:45", type: "Break" },
    {
...
const day3: Day = {
  ...
  sessions: [
    ...
    { title: "Break", time: "10:30", type: "Break" },
    {
      ...
      type: "Lecture",
      time: "11:00",
      speakers: [matt_iadanza, agnel_joseph],
    },
    {
    ...
    {
      title: "Talk or tutorial by a sponsor",
      type: "Lecture",
      time: "16:30",
    },
    {
  ...
  sessions: [
    {
      ...
      type: "Lecture",
      time: "09:00",
      speakers: [andrey_lebedev, eugene_krissinel, maria_fando],
    },
    {
      title: "Molecular replacement",
      type: "Tutorial",
    ...
    { title: "Break", time: "10:30", type: "Break" },
    {
      title: "Model-building and density modification",
      type: "Lecture",
      time: "11:00",
      speakers: [lucrezia_catapano],
    },
    {
      title: "Model-building in Coot & Moorhen",
      type: "Tutorial",
      time: "11:45",
      speakers: [lucrezia_catapano],
    },
    ...
    {
      title: "Automated model building in crystallography",
      type: "Tutorial",
      time: "14:15",
      speakers: [paul_bond],
    },

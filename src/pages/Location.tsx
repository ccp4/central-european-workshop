  ...
  return (
    <main className="m-auto flex max-w-7xl flex-col gap-4">
      ...
      <Heading text="Accommodation" />
        <p>
          You will be staying at the <Link href="https://konferencnizamek.cz/en/"
          text="Nové Hrady Castle" /> at the workshop venue. You will share a room with another participant.
          Food will be provided during the workshop from dinner on Sunday 26th April to lunch on Saturday 2nd May.
        </p>
        <p>
          Address:<br />
          &nbsp;&nbsp;&nbsp;Zámek 136<br />
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Jízdenku do Nových Hradů prosím. /<i>Yeezdenkoo doh Noveekh Hradoo proseem.</i>/</td>
          </tr>
          <tr>  
            <td>Water</td>
            <td>Voda</td>
          ...
          <tr>
            <td>Crystallographic methods are based on the scattering and<br />
                ...
                comparable to the size of the crystal lattice.
            </td>
            <td>Krystalografické metody jsou založené na rozptylu a<br />
                následné interferenci záření s vlnovou délkou<br />
          ...
          <tr>
            <td>Using electron cryo microscopy, it is possible to<br />
                ...
                complexes without the need to crystallize the sample.
            </td>

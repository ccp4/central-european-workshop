export function Home() {
  return (
    <>
      <h1>
        <span>CCP4 Structural Biology Summer School 2025</span>
        <br />
        <span>University of York, UK &ndash; 31 July to 8 August</span>
      </h1>
      ...
      <p>
        ...
        cryo-microscopy, and associated techniques. The school aims to bring
        together early-career scientists from the UK, Europe and beyond and
        train them in the latest advances in structural biology, with a primary
        focus on MX and cryo-EM.
      </p>
      <p>
      ...
      <p>
        ...
        with lectures in the main Biology building, workshops in a PC room in
        James College and accommodation in Vanbrugh College.
      </p>
      <p>
      ...
      <p>
        ...
        this sort of specialist training, and be prepared to submit the{" "}
        <b>e-mail address of a supervisor</b>
        who will write a <b>letter of recommendation</b> in support of their
        application.
      </p>
